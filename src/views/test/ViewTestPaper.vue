...
<template>
  ...
  <div class="main">
    ...
    <el-card class="box-card">
      <div slot="header" class="clearfix">
        <el-radio-group v-model="radio" @change="shows=!shows">
          <el-radio :label="1">列表</el-radio>
          <el-radio :label="2">图表</el-radio>
        </el-radio-group>
      </div>
      <!-- 列表 -->
      <el-table :data="tableDatb" v-show="shows">
      ...
      <!-- 图表 -->
      <div v-show="!shows" id="myChart" style="height:425px;"></div>
    </el-card>
  </div>
</template>
