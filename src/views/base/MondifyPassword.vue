  ...
  <div class="main">
    <el-card class="box-card">
      ...
      <el-form
        ...
        class="demo-ruleForm"
      >
        <el-form-item label="旧密码" required=true prop="password">
          <el-input type="password" v-model="ruleForm2.password" auto-complete="off"></el-input>
        </el-form-item>
        <el-form-item label="新密码" required=true ref="numberValidateForm" prop="pass">
          <el-input type="password" v-model="ruleForm2.pass" auto-complete="off"></el-input>
        </el-form-item>
        <el-form-item label="确认密码" required=true ref="numberValidateForm" prop="checkPass">
